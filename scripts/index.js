...
const inputPlaceNameNewPlace = formElementNewPlace.querySelector('.popup__form-item_type_name');
const inputLinkNewPlace = formElementNewPlace.querySelector('.popup__form-item_type_job');
